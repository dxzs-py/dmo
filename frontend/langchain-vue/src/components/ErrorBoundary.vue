...
<template>
  <div v-if="hasError" class="error-boundary">
    <div class="error-boundary__content">
      ...
      <div class="error-boundary__details" v-if="errorInfo">
        ...
        <div class="error-boundary__detail-item" v-if="errorInfo.component">
          <span class="error-boundary__detail-label">出错组件：</span>
          <span class="error-boundary__detail-value">{{ errorInfo.component }}</span>
        </div>
        <div class="error-boundary__detail-item" v-if="errorInfo.hook">
