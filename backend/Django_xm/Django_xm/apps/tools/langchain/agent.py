...
class AgentCreateTool(BaseTool):
    ...
    def _run(self, description: str, agent_type: str = "general-purpose", parent_session_id: str = "") -> str:
        from .agent_context import is_max_depth_reached, get_agent_depth, MAX_AGENT_DEPTH
        ...
        from .agent_context import get_parent_tool_context, has_parent_tool_context
    ...
    def _run(self, agent_id: str, input_text: str = "", timeout: int = 60) -> str:
        ...
        def _execute_agent():
            try:
                ...
                from .agent_context import increment_agent_depth, decrement_agent_depth, get_agent_depth, MAX_AGENT_DEPTH
