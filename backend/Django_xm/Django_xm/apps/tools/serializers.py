...
class McpToolUploadSerializer(serializers.Serializer):
    ...
    description = serializers.CharField(max_length=500, required=False, allow_blank=True, default='', help_text='工具描述')
    category = serializers.CharField(max_length=50, required=False, default='general', help_text='功能分类编码')
...
class SkillStepSerializer(serializers.Serializer):
    ...
    condition = serializers.CharField(max_length=500, required=False, allow_blank=True, default=None, help_text='执行条件表达式', allow_null=True)
    resource_path = serializers.CharField(max_length=500, required=False, allow_blank=True, default=None, help_text='Level 3 资源文件路径', allow_null=True)
...
class SkillCreateSerializer(serializers.Serializer):
    ...
    description = serializers.CharField(max_length=500, required=False, allow_blank=True, default='', help_text='描述')
    mode = serializers.ChoiceField(choices=['pipeline', 'advisor', 'hybrid'], required=False, default='pipeline', help_text='执行模式')
