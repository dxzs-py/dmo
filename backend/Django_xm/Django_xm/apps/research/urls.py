...
urlpatterns = [
    ...
    path("tasks/<str:task_id>/", DeepResearchTaskDeleteView.as_view(), name="tasks_delete"),
    path("tasks/<str:task_id>/retry-subagent/", DeepResearchRetrySubagentView.as_view(), name="tasks_retry_subagent"),
