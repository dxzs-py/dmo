"""
Agent 子代理系统
参考 claw-code-main 的 Agent 工具实现
支持创建和管理子代理任务
"""
...
from Django_xm.apps.core.config import get_logger, settings

logger = get_logger(__name__)

AGENT_STORE_DIR = os.path.join(getattr(settings, 'data_dir', 'data'), 'agents')
...
def agent_run(
    ...
    try:
        from Django_xm.apps.agents.agents import create_base_agent
        from Django_xm.apps.core.tools import BASIC_TOOLS
